...
echo set oShellLink = WshShell.CreateShortcut(("%USERPROFILE%\AppData\Roaming\Microsoft\Windows\SendTo\mp4fromavi_qsv.batへのショートカット" ^& ".lnk")) >>shortcut.vbs
echo oShellLink.TargetPath = "%~dp0mp4fromavi_qsv.bat" >>shortcut.vbs
